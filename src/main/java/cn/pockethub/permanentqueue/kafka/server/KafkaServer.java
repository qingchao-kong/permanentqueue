...
import cn.pockethub.permanentqueue.kafka.controller.KafkaController;
import cn.pockethub.permanentqueue.kafka.metadata.BrokerState;
...
public class KafkaServer extends KafkaBroker implements Server {

    public static final Long MIN_INCREMENTAL_FETCH_SESSION_EVICTION_MS = 120000L;

    private KafkaConfig config;
    private Time time;
    private Optional<String> threadNamePrefix;
    ...
    private volatile BrokerState _brokerState = BrokerState.NOT_RUNNING;
...
//
    private volatile KafkaController _kafkaController = null;
//
...
//    }
//
//    public static ZKClientConfig zkClientConfigFromKafkaConfig(KafkaConfig config, Boolean forceZkSslClientEnable) {
//        ZKClientConfig clientConfig = new ZKClientConfig();
//        if (config.getZkSslClientEnable() || forceZkSslClientEnable) {
