 ...
 */
package cn.pockethub.permanentqueue.rocketmq.broker;
...
public class ConsumerOffsetManager extends ConfigManager {
    ...
    protected transient PermanentQueueManager permanentQueueManager;
    ...
    public ConsumerOffsetManager(PermanentQueueManager permanentQueueManager) {
        this.permanentQueueManager = permanentQueueManager;
    }
...
//
//                if (null == queueManager.getConsumerManager().findSubscriptionData(group, topic)
...
//            long minOffsetInStore = this.queueManager.getMessageStore().getMinOffsetInQueue(topic, next.getKey());
...
//    }
    ...
    private void commitOffset(final String clientHost, final String key, final int queueId, final long offset) {
        ...
        if (versionChangeCounter.incrementAndGet() % permanentQueueManager.getQueueConfig().getConsumerOffsetUpdateVersionStep() == 0) {
            long stateMachineVersion = permanentQueueManager.getMessageStore() != null ? permanentQueueManager.getMessageStore().getStateMachineVersion() : 0;
    ...
    public long queryOffset(final String group, final String topic, final int queueId) {
        ...
        if (this.permanentQueueManager.getQueueConfig().isUseServerSideResetOffset()) {
    ...
    public String configFilePath() {
        return BrokerPathConfigHelper.getConsumerOffsetPath(this.permanentQueueManager.getMessageStoreConfig().getStorePathRootDir());
    }
...
//                    long minOffset = this.queueManager.getMessageStore().getMinOffsetInQueue(topic, entry.getKey());
