...
//    }
    public static LogConfig createLogConfig() {
        return createLogConfig(Defaults.SegmentMs,
                ...
                (long) Defaults.FileDeleteDelayMs);
    }

    public static LogConfig createLogConfig(Long segmentMs,
        ...
        logProps.put(LogConfig.SegmentMsProp, segmentMs);
        logProps.put(LogConfig.SegmentBytesProp, segmentBytes);
        logProps.put(LogConfig.RetentionMsProp, retentionMs);
        ...
        logProps.put(LogConfig.MaxMessageBytesProp, maxMessageBytes);
        logProps.put(LogConfig.IndexIntervalBytesProp, indexIntervalBytes);
        logProps.put(LogConfig.SegmentIndexBytesProp, segmentIndexBytes);
    ...
    public static UnifiedLog createLog(File dir,
                                       ...
                                       ConcurrentMap<String, Integer> numRemainingSegments) throws Throwable {
